...
<html>
<head>
<title>View <fmt:message key="detallecuentas.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="detallecuentas.title"/> Details</h1>
			...
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					...
					<tr>
						...
						<td>
							${detallecuentas.idTipoCuenta}
						&nbsp;
						</td>
					</tr>
				</tbody>
			</table>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteDetalleCuentas?idDetalleCuentasKey=${detallecuentas.idDetalleCuentas}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
