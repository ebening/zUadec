...
public class SolicitudDAOTest {
	 ...
	 *
	 */
	private SolicitudDAO dataStore;

	/**
	 * Instantiates a new SolicitudDAOTest.
	 *
	 */
	public SolicitudDAOTest() {
	}

	/**
	* Method to test Solicitud domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(SolicitudDAO dataStore) {
